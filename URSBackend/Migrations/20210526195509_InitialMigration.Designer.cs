...
namespace URSBackend.Migrations
{
    ...
    [Migration("20210526195509_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("URSBackend.Classroom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("URSBackend.Course", b =>
                {
            ...
            modelBuilder.Entity("URSBackend.Teacher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("URSBackend.Student", b =>
                {
            ...
            modelBuilder.Entity("ClassroomStudent", b =>
                {
                    b.HasOne("URSBackend.Classroom", null)
                        .WithMany()
                        .HasForeignKey("JoinedClassroomsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("URSBackend.Student", null)
                        .WithMany()
            ...
            modelBuilder.Entity("URSBackend.Classroom", b =>
                {
                    b.HasOne("URSBackend.Course", "ClassCourse")
                        .WithMany()
                        .HasForeignKey("ClassCourseCourseCode");

                    b.HasOne("URSBackend.Teacher", "Instructor")
                        .WithMany()
